...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"XGram.XGramDesktop.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"XGram.XGramDesktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"XGram.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"XGram Desktop/XGram.lnk"_q;
	const auto old = u"XGram for Windows/XGram.lnk"_q;
