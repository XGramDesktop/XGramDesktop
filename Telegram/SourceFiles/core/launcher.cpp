...
void ComputeExternalUpdater() {
	// XGram has no trusted binary update service yet. Do not offer or install
	// builds from the legacy fork update infrastructure.
...
void Launcher::init() {
	...
	QApplication::setApplicationName(u"XGramDesktop"_q);
