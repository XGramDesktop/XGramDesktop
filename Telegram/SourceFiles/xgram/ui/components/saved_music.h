...
class XGramMusicButton final : public Ui::RippleButton
{
public:
	XGramMusicButton(QWidget *parent, MusicButtonData data, std::optional<QColor> overrideBg, Fn<void()> handler);
	~XGramMusicButton();
