...
#include "xgram/libs/json.hpp"
#include "xgram/libs/json_ext.hpp"
...
class XGramSettings {
public:
	XGramSettings(const XGramSettings &) = delete;
	XGramSettings &operator=(const XGramSettings &) = delete;
	XGramSettings(XGramSettings &&) noexcept = default;
	XGramSettings &operator=(XGramSettings &&) noexcept = default;

	[[nodiscard]] static XGramSettings &getInstance();
	...
	[[nodiscard]] bool perChatGhostMode() const { return _perChatGhostMode.current(); }
	void setPerChatGhostMode(bool val);
	[[nodiscard]] bool isGhostModeInChat(uint64 accountId, uint64 peerId) const;
	void setGhostModeInChat(uint64 accountId, uint64 peerId, bool enabled);
	[[nodiscard]] bool globalPinsEnabled() const { return _globalPinsEnabled.current(); }
	void setGlobalPinsEnabled(bool val);
	[[nodiscard]] bool globalPinsExpanded() const { return _globalPinsExpanded.current(); }
	void setGlobalPinsExpanded(bool val);
	[[nodiscard]] bool isGloballyPinned(uint64 accountId, uint64 peerId) const;
	void setGloballyPinned(uint64 accountId, uint64 peerId, bool pinned);
	[[nodiscard]] const std::map<uint64, std::unordered_set<uint64>> &globalPinnedChats() const {
		return _globalPinnedChats;
	}
	...
	[[nodiscard]] bool persistDeletedMedia() const { return _persistDeletedMedia.current(); }
	...
	[[nodiscard]] bool suppressBlockedGroupNotifications() const { return _suppressBlockedGroupNotifications.current(); }
	[[nodiscard]] bool cryptoTickerEnabled() const { return _cryptoTickerEnabled.current(); }
	[[nodiscard]] const QString &cryptoTickerSymbol() const { return _cryptoTickerSymbol.current(); }
	[[nodiscard]] bool officialPurchasesEnabled() const { return _officialPurchasesEnabled.current(); }
	[[nodiscard]] bool profilePreviewEnabled() const { return _profilePreviewEnabled.current(); }
	[[nodiscard]] int64 previewStarsBalance() const { return _previewStarsBalance.current(); }
	[[nodiscard]] int previewGiftsCount() const { return _previewGiftsCount.current(); }
	...
	void setPersistDeletedMedia(bool val);
	...
	void setSuppressBlockedGroupNotifications(bool val);
	void setCryptoTickerEnabled(bool val);
	void setCryptoTickerSymbol(const QString &val);
	void setOfficialPurchasesEnabled(bool val);
	void setProfilePreviewEnabled(bool val);
	void setPreviewStarsBalance(int64 val);
	void setPreviewGiftsCount(int val);
	...
	[[nodiscard]] rpl::producer<bool> perChatGhostModeValue() const { return _perChatGhostMode.value(); }
	[[nodiscard]] rpl::producer<bool> perChatGhostModeChanges() const { return _perChatGhostMode.changes(); }
	[[nodiscard]] rpl::producer<bool> globalPinsEnabledValue() const { return _globalPinsEnabled.value(); }
	[[nodiscard]] rpl::producer<bool> globalPinsEnabledChanges() const { return _globalPinsEnabled.changes(); }
	[[nodiscard]] rpl::producer<bool> globalPinsExpandedValue() const { return _globalPinsExpanded.value(); }
	[[nodiscard]] rpl::producer<> globalPinsChanges() const { return _globalPinsChanges.events(); }
	...
	[[nodiscard]] rpl::producer<bool> persistDeletedMediaValue() const { return _persistDeletedMedia.value(); }
	[[nodiscard]] rpl::producer<bool> persistDeletedMediaChanges() const { return _persistDeletedMedia.changes(); }
	...
	[[nodiscard]] rpl::producer<bool> suppressBlockedGroupNotificationsValue() const { return _suppressBlockedGroupNotifications.value(); }
	[[nodiscard]] rpl::producer<bool> suppressBlockedGroupNotificationsChanges() const { return _suppressBlockedGroupNotifications.changes(); }
	[[nodiscard]] rpl::producer<bool> cryptoTickerEnabledValue() const { return _cryptoTickerEnabled.value(); }
	[[nodiscard]] rpl::producer<bool> cryptoTickerEnabledChanges() const { return _cryptoTickerEnabled.changes(); }
	[[nodiscard]] rpl::producer<QString> cryptoTickerSymbolValue() const { return _cryptoTickerSymbol.value(); }
	[[nodiscard]] rpl::producer<QString> cryptoTickerSymbolChanges() const { return _cryptoTickerSymbol.changes(); }
	[[nodiscard]] rpl::producer<bool> officialPurchasesEnabledValue() const { return _officialPurchasesEnabled.value(); }
	[[nodiscard]] rpl::producer<bool> officialPurchasesEnabledChanges() const { return _officialPurchasesEnabled.changes(); }
	[[nodiscard]] rpl::producer<bool> profilePreviewEnabledValue() const { return _profilePreviewEnabled.value(); }
	[[nodiscard]] rpl::producer<bool> profilePreviewEnabledChanges() const { return _profilePreviewEnabled.changes(); }
	[[nodiscard]] rpl::producer<int64> previewStarsBalanceValue() const { return _previewStarsBalance.value(); }
	[[nodiscard]] rpl::producer<int64> previewStarsBalanceChanges() const { return _previewStarsBalance.changes(); }
	[[nodiscard]] rpl::producer<int> previewGiftsCountValue() const { return _previewGiftsCount.value(); }
	[[nodiscard]] rpl::producer<int> previewGiftsCountChanges() const { return _previewGiftsCount.changes(); }
	...
	friend void to_json(nlohmann::json &j, const XGramSettings &s);
	friend void from_json(const nlohmann::json &j, XGramSettings &s);
...
private:
	...
	rpl::variable<bool> _persistDeletedMedia = false;
	...
	rpl::variable<bool> _suppressBlockedGroupNotifications = false;
	rpl::variable<bool> _cryptoTickerEnabled = false;
	rpl::variable<QString> _cryptoTickerSymbol = u"BTC"_q;
	rpl::variable<bool> _officialPurchasesEnabled = true;
	rpl::variable<bool> _profilePreviewEnabled = false;
	rpl::variable<int64> _previewStarsBalance = 0;
	rpl::variable<int> _previewGiftsCount = 0;
	...
	rpl::variable<bool> _perChatGhostMode = true;
	std::map<uint64, std::unordered_set<uint64>> _ghostModeChats;
	rpl::variable<bool> _globalPinsEnabled = true;
	rpl::variable<bool> _globalPinsExpanded = true;
	std::map<uint64, std::unordered_set<uint64>> _globalPinnedChats;
	rpl::event_stream<> _globalPinsChanges;
