...
class XGramLanguage : public QObject
{
	Q_OBJECT
	Q_DISABLE_COPY(XGramLanguage)

public:
	static XGramLanguage *currentInstance();
	static void init();
	static XGramLanguage *instance;
...
private:
	XGramLanguage();
	~XGramLanguage() override = default;
