		...
		auto text = item->out()
			? (isRound
				...
				: tr::lng_ttl_voice_tooltip_out)(
					...
					tr::rich)
			: (isRound
				? settings.saveDeletedMessages() ? tr::xgram_ExpiringVideoMessageNote : tr::lng_ttl_round_tooltip_in
				: settings.saveDeletedMessages() ? tr::xgram_ExpiringVoiceMessageNote : tr::lng_ttl_voice_tooltip_in)(tr::rich);
